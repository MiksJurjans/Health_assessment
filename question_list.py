list_of_questions = [
        {'category': 'sleep',
        'label': 'Question 1', 
        'text': 'Would you say you have a consistent wake-up and bed-time schedule during most of the working days?', 
        'note': '*Meaning your wake-up and bed-time do not fluctuate more than 30 min 80% of the time', 
        'type': 'radio', 
        'identifier': 'q1', 
        'options': [{'label': 'Yes', 'value': '5'}, 
                    {'label': 'No', 'value': '1'}],
        'weight': 3,
        ...
        {'category': 'sleep',
         ...
         'identifier': 'q2', 
         'value': '22:00',
         'weight': 1}, ## weight / score is for hours slept on weekdays
        ...
        {'category': 'sleep',
         ...
         'identifier': 'q3', 
         'value': '07:00',
         'weight': 0.8}, ## weight / score is for hours slept on weekends

         {'category': 'sleep',
          'label': 'Question 4', 
         'text': 'Does your weekend schedule differ significantly compared to your work week schedule?',
         'note': '*Meaning your wake-up and/or bedtime on working days differ for more than 1,5 hours compared to weekends',
         'type': 'radio', 
         'identifier': 'q4', 
        ...
        {'category': 'sleep',
         ...
         'identifier': 'q5', 
         'value': '22:00',
         'weight': 0.8}, ## score / weight is for differing wake-up time between weekdays and weekends
        ...
        {'category': 'sleep',
         ...
         'type': 'select_choice', 
         'identifier': 'q7', 
         'options': [{'label': "More than 8 hours", 'value': '5'}, 
        ...
        'label': 'Question 12', 
        'text': 'Would you say you have a consistent meal schedule during most of the working days?', 
        'note': '*Meaning you eat at the same time most of the days with no more than 1 hour difference between days', 
        'type': 'radio', 
        'identifier': 'q12', 
        'options': [{'label': 'Yes', 'value': '5'}, 
                    {'label': 'No', 'value': '1'}],
        ...
        {'category': 'meal schedule',
         ...
         'identifier': 'q13', 
         'value': '19:00',
         'weight': 1}, ## score / weight for meals before bedtime on weekdays
         ...
         'identifier': 'q14', 
         'value': '08:00',
         'weight': 1}, ## score / weight for hours spent fasting on weekdays

         {'category': 'meal schedule',
         'label': 'Question 15', 
         'text': 'Would you say your meal schedule is significantly different on weekends compared to working days?',
         'note': '*Meaning, your meal times on weekends differ for more than 2 hours compared to working days', 
         'type': 'radio', 
        'identifier': 'q15', 
        'options': [{'label': 'Yes', 'value': '1'}, 
                    {'label': 'No', 'value': '5'}],
        ...
        {'category': 'meal schedule',
         ...
         'identifier': 'q16', 
         'value': '09:00',
         'weight': 0.5}, ## score / weight for the first meal time on weekdays compared to weekends
         ...
         'identifier': 'q17', 
         'value': '20:00',
         'weight': 0.5}, ## score / weight for the last meal time on weekdays compared to weekends
        ...
        {'category': 'meal schedule',
         ...
         'type': 'select_choice', 
         'identifier': 'q18', 
         'options': [{'label': "I always eat at the same times and all my meals are pre-planned", 'value': '5'},
                     {'label': "Most of my meals are consistent and planned. Exceptions occur sometimes", 'value': '4'},
                     {'label': "I try to have a consistent schedule, but I often get busy and can stick to it", 'value': '3'},
                     {'label': "I have one consistent meal a day, but the rest depends on the situation", 'value': '2'},
                     {'label': "I don't have one. I eat at random times", 'value': '1'}],
        'weight': 2,
        'comment':'Your comment:'},
        ...
        'type': 'select_choice', 
         'identifier': 'q20', 
         'options': [{'label': "2 or less", 'value': '5'}, 
                    {'label': "3", 'value': '3'},
        ...
        {'category': 'caffeine consumption',
        'label': 'Question 21', 
        'text': 'How long (in hours) after waking up do you usually have your first caffeinated beverage?',
        'note': '*If it differs, choose the shortest time.', 
        'type': 'radio', 
        'identifier': 'q21',
        'options': [{'label': '> 1 hour', 'value': '5'}, 
        ...
        {'category': 'caffeine consumption',
        'label': 'Question 22', 
        'text': 'How long (in hours) before going to bed do you usually have your last caffeinated beverage?',
        'note': '*If it differs, choose the shortest time.',
        'type': 'select_choice', 
         'identifier': 'q22', 
         'options': [{'label': "More than 10 hours", 'value': '5'}, 
        ...
        {'category': 'caffeine consumption',
        'label': 'Question 23', 
        'text': 'Do you regularly spend at least 10 minutes outside around sunrise time?',
        ...
        'label': 'Question 24', 
        'text': 'Do you regularly spend at least 10 minutes outside around sunset time?',
        ...
        {'category': 'bright light viewing',
        'label': 'Question 25', 
        'text': 'How many minutes a day (minimum) do you spend outdoors on working days?', 
        'type': 'select_choice', 
         'identifier': 'q25', 
         'options': [{'label': "More than 60 minutes", 'value': '5'}, 
        ...
        {'category': 'bright light viewing',
        'label': 'Question 26', 
        'text': 'When (how many minutes) before bedtime is the last time you look at your phone, computer or TV? ', 
        'note': '*If it differs, state the shortest time.',
        'type': 'select_choice', 
         'identifier': 'q26', 
         'options': [{'label': "More than 60 minutes", 'value': '1'}, 
                    {'label': "30 - 60 minutes", 'value': '3'},
        ...
        {'category': 'alcohol consumption',
        'label': 'Question 28', 
        'text': 'When consuming alcohol, how many alcoholic drinks per week do you consume?', 
        'type': 'select_choice', 
         'identifier': 'q28', 
         'options': [{'label': "1", 'value': '3'}, 
                    {'label': "2", 'value': '3'},
                    {'label': "3", 'value': '1'},
                    {'label': "4", 'value': '1'},
                    {'label': "5", 'value': '1'},
        ...
        'label': 'Question 30', 
        'text': 'How often do you have difficulties waking up in the morning with the alarm?', 
        'type': 'select_choice', 
         'identifier': 'q30', 
         'options': [{'label': "Every Week", 'value': '1'}, 
                    {'label': "Often", 'value': '2'},
        ...
        'type': 'select_choice', 
         'identifier': 'q31', 
         'options': [{'label': "Almost Every Day", 'value': '1'}, 
                    {'label': "Often", 'value': '2'},
                    {'label': "50 % of the time", 'value': '3'},
                    {'label': "Rarely", 'value': '4'},
        ...
        'type': 'select_choice', 
         'identifier': 'q32', 
         'options': [{'label': "Not At All", 'value': '1'}, 
        ...
        {'category': 'energy levels',
        'label': 'Question 33', 
        'text': 'How often do you feel tired, sleepy or drowsy during the day, even when you are trying to stay alert and focused?', 
        'type': 'select_choice', 
         'identifier': 'q33', 
         'options': [{'label': "Almost Every Day", 'value': '1'}, 
                    {'label': "Often", 'value': '2'},
        ...
        {'category': 'energy levels',
        'label': 'Question 34', 
        'text': 'How often do you feel like you need caffeine or other stimulants to get through the day?', 
        'type': 'select_choice', 
         'identifier': 'q34', 
         'options': [{'label': "Almost Every Day", 'value': '1'}, 
                    {'label': "Often", 'value': '2'},
        ...
        {'category': 'energy levels',
        'label': 'Question 37', 
        'text': 'How often have you fallen asleep unintentionally during the day, such as while sitting in a meeting or driving?', 
        'type': 'select_choice', 
         'identifier': 'q37', 
         'options': [{'label': "Almost Every Day", 'value': '1'}, 
                    {'label': "Often", 'value': '2'},
        ...
        {'category': 'energy levels',
        'label': 'Question 38', 
        'text': 'How often do you have trouble falling asleep at night or staying asleep throughout the night?', 
        'type': 'select_choice', 
         'identifier': 'q38', 
         'options': [{'label': "Almost Every Day", 'value': '1'}, 
                    {'label': "Often", 'value': '2'},
        ...
        'type': 'select_choice', 
         'identifier': 'q39', 
         'options': [{'label': "I feel tired almost every day", 'value': '1'}, 
                    {'label': "I often don't have enough energy to go through the day", 'value': '2'},
        ...
        'type': 'select_choice', 
         'identifier': 'q40', 
         'options': [{'label': "Less than 8000", 'value': '1'}, 
        ...
        {'category': 'physical activity',
        'label': 'Question 41', 
        'text': 'Do you engage in purpouseful exercise regularly (at least twice a week)?',
        'note': '*Such as going to the gym, taking part in a fitness or yoga class, running, dancing, practicing a sport, martial arts, cycling, etc.', 
        'type': 'radio', 
        'identifier': 'q41',
        'options': [{'label': 'Yes', 'value': '5'}, 
                    {'label': 'No', 'value': '1'}],
        ...
        'type': 'select_choice', 
         'identifier': 'q42', 
         'options': [{'label': "2 or less", 'value': '1'}, 
                    {'label': "3 - 4", 'value': '3'},
        ...
        'type': 'select_choice', 
        'identifier': 'q50', 
        'options': [{'label': "More than 8 hours", 'value': '1'}, 
        ...
        'type': 'select_choice', 
        'identifier': 'q51', 
        'options': [{'label': "More than 12 hours", 'value': '5'},
        ...
        'type': 'text', 
        'identifier': 'q55',
        'weight': 2}, ## score / weight for FFMI
        ...
        'options': [{'label': '1', 'value': '5'}, 
                    ...
                    {'label': '7', 'value': '1'},
                    {'label': '8', 'value': '1'}],
        'image_female': 'body_composition_female.jpg', 
        'image_male': 'body_composition_male.jpg',
        'weight': 1,
        'comment':'Your comment:'}, ## score / weight for BFR
        ...
        'type': 'select_choice', 
         'identifier': 'q60', 
         'options': [{'label': "Less frequently than every second day", 'value': '1'}, 
                    {'label': "Once every second day", 'value': '1'},
                    {'label': "Once a day", 'value': '5'},
                    {'label': "2 - 3 times a day", 'value': '5'},
        ...
        'type': 'radio', 
         ...
         'options': [{'label': "Type 1", 'value': '1'}, 
                    ...
                    {'label': "Type 3", 'value': '5'},
                    {'label': "Type 4", 'value': '5'},
                    {'label': "Type 5", 'value': '3'},
                    {'label': "Type 6", 'value': '2'},
                    {'label': "Type 7", 'value': '1'}],
        'image': 'stool_type.jpg',
        'weight': 1,
        'comment':'Your comment:'},
        ...
        {'category': 'digestion',
        'label': 'Question 64', 
        'text': 'Which of these statements best describes your digestive health/feeling in your gut and stomach?',
        'type': 'select_choice', 
         'identifier': 'q64', 
         'options': [{'label': "I experience pain and discomfort in my gut daily and it really impairs my quality of life.", 'value': '1'}, 
                    {'label': "I frequently feel some discomfort in my gut, but I can live normally.", 'value': '2'},
                    {'label': "I sometimes experience discomfort in the digestive trackt, but it doesn't impair my overall wellbeing.", 'value': '3'},
                    {'label': "I rarely feel my gut and only when I have eaten something bad or too much.", 'value': '4'},
        ...
        'type': 'select_choice', 
         'identifier': 'q65', 
         'options': [{'label': "I am very sensitive to many foods and I can eat only limited types of food.", 'value': '1'}, 
                    {'label': "I am sensitive to various products but I can adjust my meals accordingly.", 'value': '3'},
        ...
        {'category': 'nutrition quality',
        'label': 'Question 68', 
        'text': 'Which of these foods do you consume regularly (at least once a week)?',
        'type': 'checkbox', 
        'identifier': 'q68',
        'options': [{'label': 'Cucumber', 'value': 'cucumber'}, 
        ...
        {'category': 'nutrition quality',
        'label': 'Question 69', 
        'text': 'Do you have at least 3 different vegetables and/or fruits in every meal?',
        'type': 'radio', 
        'identifier': 'q69',
        'options': [{'label': 'Yes', 'value': '5'}, 
                    {'label': 'No', 'value': '1'}],
        ...
        'options': [{'label': 'Pizza', 'value': 'pizza'}, 
                    ...
                    {'label': 'Spreads (such as cream cheese)', 'value': 'spreads'},
                    {'label': 'Sauces (ketchup, mayo, etc)', 'value': 'sauces'}],
        'weight': 1},
        ...
        'type': 'checkbox', 
        'identifier': 'q71',
        'options': [{'label': 'Cottage cheese', 'value': 'cottage cheese'}, 
        ...
        {'category': 'nutrition quality',
        'label': 'Question 72', 
        'text': 'Do you have at least one source of protein (from previous questions) at every meal?',
        'type': 'radio', 
        'identifier': 'q72',
        'options': [{'label': 'Yes', 'value': '5'}, 
                    {'label': 'No', 'value': '1'}],
        ...
        'note': '*Type your answer in numbers',
        'type': 'text', 
        'identifier': 'q73',
        'weight': 0.8,
        'comment':'Your comment:'},
        ...
        {'category': 'nutrition quality',
        'label': 'Question 74', 
        'text': 'Do you regularly drink or eat anything (other than water) after 7pm?',
        'type': 'radio', 
        'identifier': 'q74',
        'options': [{'label': 'Yes', 'value': '1'}, 
                    {'label': 'No', 'value': '5'}],
        ...
        'type': 'select_choice', 
         'identifier': 'q75', 
         'options': [{'label': "Multiple times a day", 'value': '1'}, 
        ...
        {'category': 'stress level',
        'label': 'Question 79', 
        'text': 'From 1 being the worst and 5 being the best: how satisfied are you with your current job/occupation?',
        'type': 'radio', 
         'identifier': 'q79', 
         'options': [{'label': "1", 'value': '1'}, 
                    {'label': "2", 'value': '2'},
        ...
        {'category': 'stress level',
        'label': 'Question 80', 
        'text': 'From 1 being the worst and 5 being the best: How do you like your living environment?',
        'type': 'radio', 
         'identifier': 'q80', 
         'options': [{'label': "1", 'value': '1'}, 
                    {'label': "2", 'value': '2'},
        ...
        'label': 'Question 81', 
        'text': 'How often do you engage in activities that you find physically and/or mentally tough?',
        'note': '*Such as purposeful exercise, studying, performing cognitively demanding task, etc',
        'type': 'select_choice', 
         'identifier': 'q81', 
         'options': [{'label': "Less than once a week", 'value': '1'}, 
        ...
        'type': 'select_choice', 
         'identifier': 'q82', 
         'options': [{'label': "Multiple times a day", 'value': '5'}, 
                    {'label': "Once a day", 'value': '4'},
                    {'label': "Once every couple days", 'value': '3'},
                    {'label': "Once a week", 'value': '2'},
        ...
        {'category': 'stress management',
        'label': 'Question 83', 
        'text': 'How often do you dedicate time to relax (doing something you find stress relieving)?',
        'type': 'select_choice', 
         'identifier': 'q83', 
         'options': [{'label': "Multiple times a day", 'value': '5'}, 
                    {'label': "Once a day", 'value': '4'},
        ...
        'type': 'select_choice', 
         'identifier': 'q84', 
         'options': [{'label': "Almost never", 'value': '1'}, 
        ...
        'type': 'select_choice', 
         'identifier': 'q86', 
         'options': [{'label': "No they don't", 'value': '1'}, 
                    {'label': "Probably, but I don't really feel it", 'value': '3'},
        ...
        {'category': 'stress management',
        'label': 'Question 88', 
        'text': 'Do you regularly use any drugs or addictive substances (at least once a month)?',
        'type': 'radio', 
        'identifier': 'q88',
        'options': [{'label': 'Yes', 'value': '1'}, 
                    {'label': 'No', 'value': '5'}],
        ...
        'label': 'Question 89', 
        'text': 'Has your doctor told you that you have any medical condition or disease?',
        ...
        {'category': 'medical history',
        'label': 'Question 91', 
        'text': 'How often are you taking over-the counter remedies for acid reflux, pain, allergies, insomnia or another condition?',
        'type': 'select_choice', 
         'identifier': 'q91', 
         'options': [{'label': "Multiple times a week", 'value': '1'}, 
                    {'label': "Once a week", 'value': '2'},
        ...
        {'category': 'medical history',
        'label': 'Question 93', 
        'text': 'Has any of your family members suffered from heart attack or stroke?',
        'type': 'radio', 
        'identifier': 'q93',
        'options': [{'label': 'Yes', 'value': '1'}, 
                    {'label': 'No', 'value': '5'}],
        ...
        {'category': 'medical history',
        'label': 'Question 96', 
        'text': "Has any of your family members suffered from Alzheimers, Parkinson's or Dementia?",
        'type': 'radio', 
        'identifier': 'q96',
        'options': [{'label': 'Yes', 'value': '1'}, 
                    {'label': 'No', 'value': '5'}],
        ...
        'type': 'select_choice', 
         'identifier': 'q97', 
         'options': [{'label': "Once a month or more often", 'value': '1'}, 
        ...
        {'category': 'medical history',
        'label': 'Question 98', 
        'text': 'From 1 being the worst and 100 being the best: How would you rate your health?',
        'type': 'text', 
        'identifier': 'q98',
        'comment':'Your comment:',
        }
